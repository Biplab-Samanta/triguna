                                	...
                                	<?php foreach($coursedetailsarray as $coursedetailsarrayvalue) { ?>
	                                    <div class="course-item">
	                                        ...
	                                        <div class="course-item-cont">
	                                            ...
	                                            <h4>
	                                                <a href="<?php echo $coursedetailsarrayvalue['courseid'];?>" data-toggle="tooltip" title="<?php echo $coursedetailsarrayvalue['coursename'];?>"><img src="<?php echo $CFG->wwwroot; ?>/theme/triguna/css/img/<?php echo $colorscheme ?>/i-c-1.png" alt=""></a>
	                                                <a href="<?php echo $coursedetailsarrayvalue['enroledusers'];?>" data-toggle="tooltip" title="<?php echo get_string('enrolusers', 'enrol'); ?>"><img src="<?php echo $CFG->wwwroot; ?>/theme/triguna/css/img/<?php echo $colorscheme ?>/i-c-2.png" alt=""></a>
	                                            </h4>
	                                        </div>
	                                    </div>
	                                <?php } ?>
