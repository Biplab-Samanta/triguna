...
<body <?php echo $OUTPUT->body_attributes(); ?>>
	...
	<input type="hidden" id="sitename" value="<?php if ( (get_config('theme_triguna', 'logoorsitename') === "sitename") ||  (get_config('theme_triguna', 'logoorsitename') === "iconsitename") ) { echo $SITE->fullname; } else { echo '';}?>">
		...
		<div id="page-content" class="row-fluid">
			<section id="region-main" class="container login-regin-main">
				...
				<?php if($isregistration->value == 'email') { ?>
					<div class="signup-link"><?php echo get_string('firsttime'); ?>
