...
Installing triguna theme
---------------------

Please unzip the theme triguna in your moodle theme folder.Now you can safely install the theme.
...
Administration > Site Administration > Appearance > Themes > triguna
from the list of theme names that appear at this point in the side block.

For any further assistance, please check the full documentation or feel free to contact triguna.
Documentation  Link:   http://triguna.dualcube.com/documentation/
