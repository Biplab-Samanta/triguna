<?php
GLOBAL $CFG;
$color_scheme = get_config('theme_triguna', 'colorscheme');
if ( get_config('theme_triguna', 'logoorsitename') === "sitename" ||  (get_config('theme_triguna', 'logoorsitename') === "iconsitename") ) {
?>
<style type = "text/css">
...
.news-updates .container:before {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/red-orange/i-notice.png) no-repeat center top;	
}
</style>
...
.news-updates .container:before {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/green/i-notice.png) no-repeat center top;	
}
@media screen and (max-width: 1199px) {
.news-updates .container:before {
background-size: 100%!important;
...
.landing-page .userbutton > span:last-child span:after {
    background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/green/dwn-arrow-landing.png) no-repeat scroll right 8px;
}
...
.rememberpass input + label:before {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/green/i-ch-unch-2.png) no-repeat center;			
}

.rememberpass input + label:after {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/i-ch-unch-2.png) no-repeat center;
}

.rememberpass input:checked + label:before {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/green/i-ch-ch-2.png) no-repeat center;	
}

.userbutton > span:last-child span:after {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/green/dwn-arrow.png) no-repeat center right;	
}

.landing-page .active-drop-user-menu .userbutton > span:last-child span:after {
    background: rgba(0, 0, 0, 0) url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/green/dwn-arrow-landing-hover.png) no-repeat scroll right 8px;
}
...
.news-updates .container:before {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/blue/i-notice.png) no-repeat center top;	
}
@media screen and (max-width: 1199px) {
.news-updates .container:before {
background-size: 100%!important;
...
.news-updates .container:before {
	background: url(theme/triguna/css/img/blue/i-notice.png) no-repeat center top;	
}
.landing-page .userbutton > span:last-child span:after {
    background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/blue/dwn-arrow-landing.png) no-repeat scroll right 8px;
}
...
.rememberpass input + label:before {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/blue/i-ch-unch-2.png) no-repeat center;			
}
...
.rememberpass input:checked + label:before {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/blue/i-ch-ch-2.png) no-repeat center;	
}

.userbutton > span:last-child span:after {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/blue/dwn-arrow.png) no-repeat center right;	
}

.landing-page .active-drop-user-menu .userbutton > span:last-child span:after {
    background: rgba(0, 0, 0, 0) url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/blue/dwn-arrow-landing-hover.png) no-repeat scroll right 8px;
}
...
.news-updates .container:before {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/orange/i-notice.png) no-repeat center top;	
}
@media screen and (max-width: 1199px) {
.news-updates .container:before {
background-size: 100%!important;
...
.landing-page .userbutton > span:last-child span:after {
    background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/orange/dwn-arrow-landing.png) no-repeat scroll right 8px;
}
...
.rememberpass input + label:before {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/orange/i-ch-unch-2.png) no-repeat center;			
}
...
.rememberpass input:checked + label:before {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/orange/i-ch-ch-2.png) no-repeat center;	
}

.userbutton > span:last-child span:after {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/orange/dwn-arrow.png) no-repeat center right;	
}

.landing-page .active-drop-user-menu .userbutton > span:last-child span:after {
    background: rgba(0, 0, 0, 0) url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/orange/dwn-arrow-landing-hover.png) no-repeat scroll right 8px;
}
...
.news-updates .container:before {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/purple/i-notice.png) no-repeat center top;	
}
@media screen and (max-width: 1199px) {
.news-updates .container:before {
background-size: 100%!important;
...
.news-updates .container:before {
	background: url(theme/triguna/css/img/purple/i-notice.png) no-repeat center top;	
}
.landing-page .userbutton > span:last-child span:after {
    background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/purple/dwn-arrow-landing.png) no-repeat scroll right 8px;
}
...
.rememberpass input + label:before {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/purple/i-ch-unch-2.png) no-repeat center;			
}
...
.rememberpass input:checked + label:before {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/purple/i-ch-ch-2.png) no-repeat center;	
}

.userbutton > span:last-child span:after {
	background: url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/purple/dwn-arrow.png) no-repeat center right;	
}

.landing-page .active-drop-user-menu .userbutton > span:last-child span:after {
    background: rgba(0, 0, 0, 0) url(<?php echo $CFG->wwwroot ?>/theme/triguna/css/img/purple/dwn-arrow-landing-hover.png) no-repeat scroll right 8px;
}
